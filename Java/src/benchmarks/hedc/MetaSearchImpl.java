...
public class MetaSearchImpl implements MetaSearch {
    ...
    public static void resetStaticFields_falcon() {
    	MSR_TEMPLATE_LOCATION_ = null;
    	MSR_FRAME_TEMPLATE_ = "hedc_synoptic_frame";
    	MSR_ROW_HEADER_TEMPLATE_ = null;
    	MSR_ROW_LINE_TEMPLATE_ = null;
    	MSR_ROW_EMPTY_LINE_TEMPLATE_ = null;
    ...
    public List search(Hashtable h, MetaSearchRequest r) {
        ...
        if (dateString != null)
            try {
                Messages.debug(-1, "MetaSearch::search before parse: "+dateString);
