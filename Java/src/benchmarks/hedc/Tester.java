...
public class Tester implements Runnable {
    ...
    String source = 
 	(System.getProperty("os.name").contains("Windows"))?
		"C:\\tomowind\\workspace\\subjects\\src\\benchmarks\\hedc\\properties.txt":
		"/homelocal/sangmin/falcon/subjects/hedc/properties.txt";
    SystemProperties.setSource(source);
    ...
    MetaSearchImpl.resetStaticFields_falcon();
