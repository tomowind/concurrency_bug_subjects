...
// synchronise threads and start timer
        ...
        for(int i=0;i<JGFRayTracerBench.nthreads;i++)
            if (id==i) {
//            	JGFRayTracerBench.checksum1=JGFRayTracerBench.checksum1+checksum;
            	long temp = JGFRayTracerBench.checksum1+checksum;
            	JGFRayTracerBench.checksum1= temp;
            }
        }
